    ...
    render(){
        return <div className="container-fluid offset-md-3 col-md-6 mt-5 mb-5 px-4">
                ...
                <div className="row d-flex justify-content-between">
                    ...
                    <div className="d-flex flex-column justify-content-center align-items-center col-6 px-0">
                        <div className="d-flex">
                            <strong className="col mx-0 px-1">15</strong><p className="col mx-0 px-1"><small>Unidades</small></p><strong className="col mx-0 px-1">12.000</strong>
                        </div>
