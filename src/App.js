  ...
  return (
    <div className="App mb-5">
        <Switch>
                ...
                <Route path="/Licor" render={() => <div><h1 className="mt-5">CARTA DE COCTELES</h1> <Licor/></div>} />
                ...
                <Route path="/Coffe" render={() => <div><h1 className="mt-5">CARTA DE POSTRES</h1> <Coffe/></div>} />
