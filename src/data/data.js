const dataProducts = [{
        ...
        products: [{
            ...
            } */,
            {
                id: 6,
                name: 'Goujonettes',
                description: 'de Pescado Apanado y su Salsa',
                price: '7.000'
            },
            {
                id: 7,
    ...
    },
    {
        ...
        products: [{
            ...
            },
            {
                id: 2,
                name: 'Salmón',
                description: 'con Salmón Pochado, Marinado y Dressing César',
                price: '9.000'
            },
            {
                id: 3,
                name: 'Quesos',
                description: 'con Nuestra Selección de 4 Quesos y Nueces',
                price: '9.000'
            },
            {
                id: 4,
                name: 'Chèvre “Chaud”',
                description: 'con Tomates Deshidratados y Semillas',
                price: '9.000'
            },
            {
                id: 5,
                name: 'Canard',
                description: 'con Magret, Confit, Mollejas y Foie Gras',
                price: '10.000'
            }
        ]
    },
    {
        ...
        products: [{
                id: 1,
                name: 'Los 33 Ravioles',
                description: 'con Queso de Cabra, Perejil y Ajo',
                price: '11.000'
            },
            {
                id: 2,
                name: 'Ñoquis',
                description: 'con Salsa 4 Quesos y Nueces',
                price: '9.000'
            },
            {
                id: 3,
    ...
    },
    {
        ...
        products: [{
            ...
            },
            {
                id: 2,
                name: 'Merluza Frita',
                description: 'con Base de Puerro y Tomate',
                price: '12.000'
            },
            {
                id: 3,
                name: 'Merluza a la Vasca',
                description: 'con Piperrada y Arroz',
                price: '12.000'
            },
            {
                id: 4,
                name: 'Reineta “Meunière”',
                description: 'con Piperrada y Aligot',
                price: '13.000'
            },
            {
                id: 5,
                name: 'Salmón Sellado',
                description: 'con Gratín de Zapallo y Tomates Provenzal',
                price: '14.000'
            }
        ]
    },
    {
        ...
        products: [{
                id: 1,
                name: 'Steak “Tartar”',
                description: 'Filete de Res “CRUDO” con Huevo, Ensalada Verde y Papas Fritas',
                price: '10.000'
            },
            {
                id: 2,
                name: 'Aiguillette de Canard',
                description: 'con Salsa Pimienta Verdey Papas Fritas',
                price: '12.000'
            },
            {
                id: 3,
            ...
            },
            {
                id: 4,
                name: 'Cassoulet',
                description: 'Confit de Canard, Saucisse y Alubias',
                price: '12.000'
            },
            {
                id: 5,
                name: 'Lentejas de “Don Cesar”',
                description: 'con Corte de Cerdo y Huevo',
                price: '10.000'
            },
            {
                id: 6,
                name: 'Boeuf Bourguignon',
                description: 'Sobre Papas Confitadas',
                price: '10.000'
            },
            {
                id: 7,
                name: 'Strogonoff de Filete',
                description: 'con Champiñones y Arroz',
                price: '12.000'
            },
            {
                id: 8,
                name: 'Medallón de filete',
                description: 'con Salsa Béarnaise y “Pont Neuf”',
                price: '14.000'
            },
            {
                id: 9,
                name: 'Medallón de filete',
                description: 'al Natural, Sólo Lechuga',
                price: '12.000'
            }
        ]
    }
